(function ($) {
    ...
    // jQuery MeanMenu activation code
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<div class='mobile-menu-nav-back'><button onclick='goBack()' style='    background: transparent; border: none;  margin-top: 3px;' class='logo-mobile'><i class='fa fa-angle-double-left fa-2x' style='color:#fff;margin-left: 10px;'></i></button><span></span></div>"});
