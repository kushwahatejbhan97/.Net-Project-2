<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AutoCompleteExtender.aspx.cs" Inherits="LocalPandit.AutoCompleteExtender" %>
...
<body>
    ...
    <div id="cp-search-form">
      <asp:DropDownList ID="ddlCity" runat="server" class="select2">
