<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="LocalPandit.WebForm1" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 item-mb">
                        <div class="service-box1 bg-body text-center">
                            ...
                            <h3 class="title-medium-dark mb-none">
                                <a href="https://www.radiustheme.com/demo/html/classipost/classipost/category-grid-layout2.htm">Cars &amp; Vehicles</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 item-mb">
                        <div class="service-box1 bg-body text-center">
                            ...
                            <h3 class="title-medium-dark mb-none">
                                <a href="category-list-layout2.html">Hobby, Sport &amp; Kids</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 item-mb">
                        <div class="service-box1 bg-body text-center">
                            ...
                            <h3 class="title-medium-dark mb-none">
                                <a href="category-list-layout3.html">House &amp; Appartment</a>
                            </h3>
                    ...
                    <div class="row featuredContainer">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 random new">
                            <div class="product-box item-mb zoom-gallery">
                                ...
                                <div class="item-content">
                                    <div class="title-ctg">Clothing</div>
                                    <h3 class="short-title"><a href="https://www.radiustheme.com/demo/html/classipost/classipost/single-product1.html">V-Neck T-Shirt</a></h3>
