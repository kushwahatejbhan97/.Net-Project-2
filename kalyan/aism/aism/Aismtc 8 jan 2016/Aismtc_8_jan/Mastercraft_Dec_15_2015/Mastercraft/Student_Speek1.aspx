<%@ Page Title="" Language="C#" MasterPageFile="~/Testimonials.Master" AutoEventWireup="true" CodeBehind="Student_Speek1.aspx.cs" Inherits="Mastercraft.Student_Speek1" %>
...
<div class="vikwidget_right vikshadow">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PriyamarketingConnectionString1 %>"
        DeleteCommand="DELETE FROM [aismtc_student_speak] WHERE [id] = @id" InsertCommand="INSERT INTO [aismtc_student_speak] ([page_name], [writer], [image_url], [text]) VALUES (@page_name, @writer, @image_url, @text)"
