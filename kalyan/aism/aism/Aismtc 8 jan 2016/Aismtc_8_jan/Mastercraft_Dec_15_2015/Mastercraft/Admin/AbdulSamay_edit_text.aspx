<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbdulSamay_edit_text.aspx.cs" Inherits="Mastercraft.Admin.AbdulSamay_edit_text" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3>Mohammed Abdul Samay Sayeed</h3>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="Mohammed Abdul Samay Sayeed" Name="text" Type="String" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="page_name" Type="String" />
                  <asp:Parameter Name="header" Type="String" />
