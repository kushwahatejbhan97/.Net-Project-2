<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mission_text_edit.aspx.cs" Inherits="Mastercraft.Admin.Mission_text_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3>Mission & Vision Text Edit</h3>
          	<p>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="Misssion & Vission" Name="text" Type="String" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="page_name" Type="String" />
                  <asp:Parameter Name="header" Type="String" />
