<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_text_testimpnial_master.aspx.cs" ValidateRequest = "false" Inherits="Mastercraft.Admin.edit_text_testimpnial_master" %>
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li>  <asp:Button class="logout" ID="Button1"  runat="server" Text="Logut"></asp:Button></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <p>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<asp:DetailsView ID="DetailsView1" runat="server" Width="462px" Height="50px" 
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ...
                  DeleteCommand="DELETE FROM [aismtc_testimonials] WHERE [id] = @id" 
                  InsertCommand="INSERT INTO [aismtc_testimonials] ([page_name], [writer], [image_url], [text]) VALUES (@page_name, @writer, @image_url, @text)" 
                  ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
                  SelectCommand="SELECT [id], [page_name], [writer], [image_url], [text] FROM [aismtc_testimonials] WHERE [id]= @id " 
                  UpdateCommand="UPDATE [aismtc_testimonials] SET [page_name] = @page_name, [writer] = @writer,  [text] = @text WHERE [id] = @id">
                  <SelectParameters>
