<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_text_master_copy.aspx.cs" Inherits="Mastercraft.Admin.edit_text_master_copy" %>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  SelectCommand="SELECT [id], [page_name], [header], [text] FROM [aismtc_text] WHERE [id]= @id " 
