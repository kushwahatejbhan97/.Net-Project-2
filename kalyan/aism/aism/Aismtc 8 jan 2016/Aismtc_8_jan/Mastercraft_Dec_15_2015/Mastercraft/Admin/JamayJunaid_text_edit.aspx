<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JamayJunaid_text_edit.aspx.cs" Inherits="Mastercraft.Admin.JamayJunaid_text_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3>Mohammed Abdul Jamay Junaid Text Edit</h3>
          	<div class="row mt">
          		<p>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="Mohammed Abdul Jamay Junaid" Name="text" Type="String" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="page_name" Type="String" />
                  <asp:Parameter Name="header" Type="String" />
