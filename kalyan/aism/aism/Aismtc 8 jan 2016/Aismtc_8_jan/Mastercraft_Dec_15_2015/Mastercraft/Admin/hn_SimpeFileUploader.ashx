    ...
    try
    {
        ...
        foreach (string s in context.Request.Files)
        {
            ...
            if (!string.IsNullOrEmpty(fileName))
            {
                ...
                string pathToSave620_300 = HttpContext.Current.Server.MapPath("~/MediaUploader/620_300/") + str_image;
                ...
                int id = 0;
                id = dalclass.add_New_Media(fileName, "<img src='/MediaUploader/" + str_image + "' alt ='" + fileName + "' class='imgclas' >", "abc", "<img src='/MediaUploader/620_300/ " + str_image + "' alt ='" + fileName + "' class='imgclas1' >", str_image);
