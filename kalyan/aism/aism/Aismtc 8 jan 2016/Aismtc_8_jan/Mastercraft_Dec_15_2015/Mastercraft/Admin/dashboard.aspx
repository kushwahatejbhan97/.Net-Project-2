<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="Mastercraft.Admin.dashboard" %>
          	...
          	<div class="row mt">
          		...
          		<p>
                    ...
                    <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
                        DataKeyNames="certification_no" DataSourceID="SqlDataSource3" 
                        DefaultMode="Insert" Height="50px" Width="665px">
                        <Fields>
                            <asp:BoundField DataField="certification_no" HeaderText="Certification No" 
                                ReadOnly="True" SortExpression="Certification No">
                            ...
                            <asp:BoundField DataField="date_of_completion" HeaderText="Date Of Completion" 
                                SortExpression="date_of_completion" >
                            <ControlStyle CssClass="form-control" />
                            </asp:BoundField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ...
                        DeleteCommand="DELETE FROM [aismtc_allumuni] WHERE [certification_no] = @certification_no" 
                        InsertCommand="INSERT INTO [aismtc_allumuni] ([certification_no], [name], [fathers_name], [course_name], [grade], [date_of_completion]) VALUES (@certification_no, @name, @fathers_name, @course_name, @grade, @date_of_completion)" 
                        ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
                        SelectCommand="SELECT [certification_no], [name], [fathers_name], [course_name], [grade], [date_of_completion] FROM [aismtc_allumuni]" 
                        UpdateCommand="UPDATE [aismtc_allumuni] SET [name] = @name, [fathers_name] = @fathers_name, [course_name] = @course_name, [grade] = @grade, [date_of_completion] = @date_of_completion WHERE [certification_no] = @certification_no">
                        <DeleteParameters>
                    ...
                    <p>
                        <asp:GridView ID="GridView1" class="table table-bordered table-striped table-condensed"   runat="server" AllowPaging="True" 
                            AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="certification_no" 
                            DataSourceID="SqlDataSource1" 
                            EmptyDataText="There are no data records to display.">
                            <Columns>
                                <asp:BoundField DataField="certification_no" HeaderText="certification_no" 
                                    ReadOnly="True" SortExpression="certification_no" />
                                <asp:BoundField DataField="name" HeaderText="name" SortExpression="name" />
                                ...
                                <asp:BoundField DataField="course_name" HeaderText="course_name" 
                                    SortExpression="course_name" />
                                <asp:BoundField DataField="grade" HeaderText="grade" SortExpression="grade" />
                                <asp:BoundField DataField="date_of_completion" HeaderText="date_of_completion" 
                                    SortExpression="date_of_completion" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            InsertCommand="INSERT INTO [aismtc_allumuni] ([certification_no], [name], [fathers_name], [course_name], [grade], [date_of_completion]) VALUES (@certification_no, @name, @fathers_name, @course_name, @grade, @date_of_completion)" 
                            ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
                            SelectCommand="SELECT [certification_no], [name], [fathers_name], [course_name], [grade], [date_of_completion] FROM [aismtc_allumuni] ORDER BY [certification_no] DESC" 
