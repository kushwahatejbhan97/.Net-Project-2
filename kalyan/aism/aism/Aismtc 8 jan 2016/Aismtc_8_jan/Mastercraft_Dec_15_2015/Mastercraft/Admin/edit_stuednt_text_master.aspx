<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_stuednt_text_master.aspx.cs" ValidateRequest = "false" Inherits="Mastercraft.Admin.edit_stuednt_text_master" %>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ...
                  SelectCommand="SELECT [id], [page_name], [writer], [image_url], [text] FROM [aismtc_student_speak] WHERE [id]= @id " 
                  UpdateCommand="UPDATE [aismtc_student_speak] SET [page_name] = @page_name, [writer] = @writer,  [text] = @text WHERE [id] = @id">
                  <SelectParameters>
