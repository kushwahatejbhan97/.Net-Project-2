<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Testimonials.aspx.cs" Inherits="Mastercraft.Admin.Testimonials" %>
      ...
      <section id="main-content">
          ...
          <h3>Testimonials</h3>
          	<div class="row mt">
                  ...
                  InsertCommand="INSERT INTO [aismtc_testimonials] ([page_name], [writer], [text]) VALUES (@page_name, @writer, @text)" 
      ...
      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
          ...
          <Columns>
              ...
              <asp:HyperLinkField DataNavigateUrlFields="id" 
                  DataNavigateUrlFormatString="edit_text_testimpnial_master.aspx?id={0}" 
                  Text="Edit" />
