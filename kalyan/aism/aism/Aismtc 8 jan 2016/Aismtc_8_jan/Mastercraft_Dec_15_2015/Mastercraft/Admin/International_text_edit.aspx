<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="International_text_edit.aspx.cs" Inherits="Mastercraft.Admin.International_text_edit" %>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
           <h3>International Text Edit</h3>
         <asp:DetailsView class="table table-bordered table-striped table-condensed"  
          ID="DetailsView1" runat="server" 
                  AutoGenerateRows="False" DataKeyNames="id" DataSourceID="SqlDataSource1" 
                  Height="50px" Width="834px" DefaultMode="Insert">
                  <Fields>
                      <asp:BoundField DataField="id" HeaderText="ID" InsertVisible="False" 
                          ReadOnly="True" SortExpression="id" />
                      <asp:TemplateField HeaderText="International Packages">
                       <InsertItemTemplate>
                    <asp:DropDownList ID="International_Packages" Enabled="false" CssClass="form-control" runat="server" Text="<% # Bind('International_Packages') %>">
                    <asp:ListItem>International Packages</asp:ListItem>
                      ...
                      <asp:BoundField DataField="collapseOne" HeaderText="Unique ID" 
                          SortExpression="collapseOne" >
                      <ControlStyle CssClass="form-control" />
                      <HeaderStyle Wrap="False" />
                      </asp:BoundField>
                      <asp:TemplateField HeaderText="Text">
                         <InsertItemTemplate>
                            ...
                            <CKEditor:CKEditorControl Id="Text" Text="<% # Bind('Text') %>" runat="server" Height="200" BasePath="~/ckeditor">
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  DeleteCommand="DELETE FROM [aismtc_packages] WHERE [id] = @id" 
                  InsertCommand="INSERT INTO [aismtc_packages] ([page_name], [header], [collapseOne], [text]) VALUES (@page_name, @header, @collapseOne, @text)" 
                  ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
                  SelectCommand="SELECT [id], [page_name], [header], [collapseOne], [text] FROM [aismtc_packages]" 
			     ...
			     <asp:GridView class="table table-bordered table-striped table-condensed" ID="GridView1" runat="server" AllowPaging="True" 
          ...
          <Columns>
              ...
              <asp:BoundField DataField="header" HeaderText="Header" 
                  SortExpression="header" />
              <asp:BoundField DataField="collapseOne" HeaderText="CollapseOne" 
                  SortExpression="collapseOne" />
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ...
          InsertCommand="INSERT INTO [aismtc_packages] ([page_name], [header], [collapseOne], [text]) VALUES (@page_name, @header, @collapseOne, @text)" 
          ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
          SelectCommand="SELECT [id], [page_name], [header], [collapseOne], [text] FROM [aismtc_packages] WHERE ([page_name] = @page_name) ORDER BY [id] DESC" 
          UpdateCommand="UPDATE [aismtc_packages] SET [page_name] = @page_name, [header] = @header, [collapseOne] = @collapseOne, [text] = @text WHERE [id] = @id">
          <DeleteParameters>
              <asp:Parameter Name="id" Type="Int32" />
          </DeleteParameters>
          ...
          <SelectParameters>
              <asp:Parameter DefaultValue="International Packages" Name="page_name" Type="String" />
          </SelectParameters>
          <UpdateParameters>
              <asp:Parameter Name="page_name" Type="String" />
              <asp:Parameter Name="header" Type="String" />
