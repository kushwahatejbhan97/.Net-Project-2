<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PgDiploma_text_edit.aspx.cs" Inherits="Mastercraft.Admin.PgDiploma_text_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          ID="DetailsView1" runat="server" 
                  ...
                  <Fields>
                      ...
                      <asp:TemplateField HeaderText="PG Deploma & Deploma">
                       <InsertItemTemplate>
                    <asp:DropDownList ID="PG_Deploma" Enabled="false" CssClass="form-control" runat="server" Text="<% # Bind('PG_Deploma') %>">
                    <asp:ListItem>PG Deploma & Deploma</asp:ListItem>
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ...
          <SelectParameters>
              <asp:Parameter DefaultValue="PG Deploma & Deploma" Name="page_name" Type="String" />
          </SelectParameters>
          <UpdateParameters>
              <asp:Parameter Name="page_name" Type="String" />
              <asp:Parameter Name="header" Type="String" />
