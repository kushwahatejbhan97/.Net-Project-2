<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="image_upload.aspx.cs" Inherits="Mastercraft.Admin.image_upload" %>
...
<ItemStyle CssClass="imgclas"></ItemStyle>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             DeleteCommand="DELETE FROM [aismtc_img_upload] WHERE [id] = @id" 
             InsertCommand="INSERT INTO [aismtc_img_upload] ([file_name], [url], [author], [date], [url_620_300], [original_url]) VALUES (@file_name, @url, @author, @date, @url_620_300, @original_url)" 
             ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
             SelectCommand="SELECT [id], [file_name], [url], [author], [date], [url_620_300], [original_url] FROM [aismtc_img_upload] ORDER BY [id] DESC" 
             
             UpdateCommand="UPDATE [aismtc_img_upload] SET [file_name] = @file_name, [url] = @url, [author] = @author, [date] = @date, [url_620_300] = @url_620_300, [original_url] = @original_url WHERE [id] = @id">
             <DeleteParameters>
