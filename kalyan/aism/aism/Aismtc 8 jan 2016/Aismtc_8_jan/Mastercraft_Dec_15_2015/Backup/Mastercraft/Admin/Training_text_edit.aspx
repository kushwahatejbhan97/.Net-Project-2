<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Training_text_edit.aspx.cs" Inherits="Mastercraft.Admin.Training_text_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
          ...
          ID="DetailsView1" runat="server" 
                  ...
                  <Fields>
                      ...
                      <asp:TemplateField HeaderText="TRAININGS">
                       <InsertItemTemplate>
                    <asp:DropDownList ID="TRAININGS" Enabled="false" CssClass="form-control" runat="server" Text="<% # Bind('TRAININGS') %>">
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ...
          <SelectParameters>
              <asp:Parameter DefaultValue="TRAININGS" Name="page_name" Type="String" />
          </SelectParameters>
          <UpdateParameters>
              <asp:Parameter Name="page_name" Type="String" />
              <asp:Parameter Name="header" Type="String" />
