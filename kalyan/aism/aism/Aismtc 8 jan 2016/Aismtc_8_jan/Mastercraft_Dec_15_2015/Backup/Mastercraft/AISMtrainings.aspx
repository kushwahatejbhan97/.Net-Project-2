<%@ Page Title="" Language="C#" MasterPageFile="~/Courses.Master" AutoEventWireup="true" CodeBehind="AISMtrainings.aspx.cs" Inherits="Mastercraft.AISMtrainings" %>
...
<div class="vikwidget_right ">
                ...
                <div class="vikheader" >
        <div class="" style=" ">
            <h4 style="font-size:20px;font-weight:600;margin-left:20px; color:Navy;">FINAL EDITING</h4>
        ...
        SelectCommand="SELECT [id], [page_name], [header], [collapseOne], [text] FROM [aismtc_packages] WHERE  [page_name]='TRAININGS' "
