<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoGallery.aspx.cs" Inherits="Mastercraft.Admin.VideoGallery" %>
      ...
      <section id="main-content">
          ...
          <h3>Video Gallery</h3>
          	<div class="row mt">
                    ...
                    <asp:DetailsView class="table table-bordered table-striped table-condensed"    ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                        DataKeyNames="id" DataSourceID="SqlDataSource1" DefaultMode="Insert" 
                        Height="50px" Width="834px">
                        <Fields>
                            <asp:BoundField DataField="id" HeaderText="id"  InsertVisible="False" 
                                ReadOnly="True" SortExpression="id" />
                            <asp:TemplateField HeaderText="Iframe">

                              <InsertItemTemplate>
                            
                            <CKEditor:CKEditorControl Id="Iframe" Text="<% # Bind('Iframe') %>" runat="server" Height="200" BasePath="~/ckeditor">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        DeleteCommand="DELETE FROM [aismtc_video] WHERE [id] = @id" 
                        InsertCommand="INSERT INTO [aismtc_video] ([iframe]) VALUES (@iframe)" 
                        SelectCommand="SELECT [id], [iframe] FROM [aismtc_video]" 
                        UpdateCommand="UPDATE [aismtc_video] SET [iframe] = @iframe WHERE [id] = @id">
                        <DeleteParameters>
                            <asp:Parameter Name="id" Type="Int32" />
                        </DeleteParameters>
                        <InsertParameters>
                            <asp:Parameter Name="iframe" Type="String" />
                        </InsertParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="iframe" Type="String" />
                            <asp:Parameter Name="id" Type="Int32" />
