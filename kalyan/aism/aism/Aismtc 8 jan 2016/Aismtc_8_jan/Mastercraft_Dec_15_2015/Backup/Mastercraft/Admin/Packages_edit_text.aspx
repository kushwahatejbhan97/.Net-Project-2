<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Packages_edit_text.aspx.cs" Inherits="Mastercraft.Admin.Packages_edit_text" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
          ...
          ID="DetailsView1" runat="server" 
                  ...
                  <Fields>
                      ...
                      <asp:TemplateField HeaderText="Page Name">
                       <InsertItemTemplate>
                    <asp:DropDownList ID="page_name" Enabled="false" CssClass="form-control" runat="server" Text="<% # Bind('page_name') %>">
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ...
          <SelectParameters>
              <asp:Parameter DefaultValue="Packages" Name="page_name" Type="String" />
          </SelectParameters>
          <UpdateParameters>
              <asp:Parameter Name="page_name" Type="String" />
              <asp:Parameter Name="header" Type="String" />
