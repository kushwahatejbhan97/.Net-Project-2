<%@ Page Title="" Language="C#" MasterPageFile="~/about_master.Master" AutoEventWireup="true" CodeBehind="quality_policy1.aspx.cs" Inherits="Mastercraft.quality_policy1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<div class="vikwidget_right " style="height:850px;">
                <div class="vikheader" >
