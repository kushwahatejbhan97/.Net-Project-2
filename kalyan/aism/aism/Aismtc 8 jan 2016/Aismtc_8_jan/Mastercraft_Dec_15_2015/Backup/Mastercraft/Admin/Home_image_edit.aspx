<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_image_edit.aspx.cs" Inherits="Mastercraft.Admin.Home_image_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3>Home Image Edit</h3>
          	<div class="row mt">
          
            
          		<div class="showback" style=" width:90%; margin:0 auto; height:130px;">
                  <h4 style=" color:Black;  margin-bottom:30px; ">Banner Image</h4>
                <div class = "col-lg-2">
                ...
                <div class = "col-lg-4">
                    ...
                    <div class = "col-lg-4">
                <asp:Button ID="Button3" class="btn btn-primary"  runat="server" Text="upload" onclick="Button3_Click"></asp:Button> 
                    ...
                    <div class="showback" style=" width:90%; margin:0 auto; height:130px;">
                  <h4 style=" color:Black;  margin-bottom:30px; ">Working Image</h4>
                <div class = "col-lg-2">
                ...
                <asp:Button ID="Button2" class="btn btn-primary"  runat="server" Text="upload" onclick="Button2_Click"></asp:Button> 
                    ...
                    <div class="showback" style=" width:90%; margin:0 auto; height:130px;">
                  <h4 style=" color:Black;  margin-bottom:30px; ">Success Story Image</h4>
                <div class = "col-lg-2">
                ...
                <div class = "col-lg-4">
                    ...
                    <div class = "col-lg-4">
                <asp:Button ID="Button4" class="btn btn-primary"  runat="server" Text="upload" onclick="Button4_Click"></asp:Button> 
                    ...
                    <div class="showback" style=" width:90%; margin:0 auto; height:130px;">
                  <h4 style=" color:Black;  margin-bottom:30px; ">Gallery Image</h4>
                <div class = "col-lg-2">
                ...
                <div class = "col-lg-4">
                    <asp:FileUpload CssClass=" form-control" ID="FileUpload4" runat="server"></asp:FileUpload>
                    </div>
                    <div class = "col-lg-4">
                <asp:Button ID="Button5" class="btn btn-primary"  runat="server" Text="upload" onclick="Button5_Click"></asp:Button> 

                 </div>
      				</div>
                    <br />
                   <div class="showback" style=" width:90%; margin:0 auto; height:130px;">
                  <h4 style=" color:Black;  margin-bottom:30px; ">Home Welcome Image</h4>
                <div class = "col-lg-4">
                    <asp:FileUpload CssClass=" form-control" ID="FileUpload5" runat="server"></asp:FileUpload>
                    </div>
                    <div class = "col-lg-4">
                <asp:Button ID="Button6" class="btn btn-primary" runat="server" Text="upload" onclick="Button6_Click"></asp:Button> 
