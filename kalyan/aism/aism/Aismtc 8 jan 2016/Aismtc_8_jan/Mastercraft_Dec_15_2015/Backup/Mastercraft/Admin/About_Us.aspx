<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About_Us.aspx.cs" Inherits="Mastercraft.Admin.About_Us" %>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="About Us" Name="text" Type="String" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="page_name" Type="String" />
                  <asp:Parameter Name="header" Type="String" />
