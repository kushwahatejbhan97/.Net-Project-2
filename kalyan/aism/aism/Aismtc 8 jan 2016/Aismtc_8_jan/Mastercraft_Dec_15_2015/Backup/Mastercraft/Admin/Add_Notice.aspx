<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Notice.aspx.cs" Inherits="Mastercraft.Admin.Add_Notice" %>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  DeleteCommand="DELETE FROM [aismtc_notice] WHERE [id] = @id" 
                  InsertCommand="INSERT INTO [aismtc_notice] ([heading], [img_url], [text]) VALUES (@heading, @img_url, @text)" 
                  SelectCommand="SELECT [id], [heading], [img_url], [text] FROM [aismtc_notice]" 
                  UpdateCommand="UPDATE [aismtc_notice] SET [heading] = @heading, [img_url] = @img_url, [text] = @text WHERE [id] = @id">
                  <DeleteParameters>
