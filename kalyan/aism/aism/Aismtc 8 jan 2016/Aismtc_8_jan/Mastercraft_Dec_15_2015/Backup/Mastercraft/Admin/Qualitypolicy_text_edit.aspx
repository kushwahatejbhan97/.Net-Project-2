<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qualitypolicy_text_edit.aspx.cs" Inherits="Mastercraft.Admin.Qualitypolicy_text_edit" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3>Quality Policy Text Edit</h3>
          	<div class="row mt">
          		<p>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="Quality Policy" Name="text" Type="String" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="page_name" Type="String" />
                  <asp:Parameter Name="header" Type="String" />
