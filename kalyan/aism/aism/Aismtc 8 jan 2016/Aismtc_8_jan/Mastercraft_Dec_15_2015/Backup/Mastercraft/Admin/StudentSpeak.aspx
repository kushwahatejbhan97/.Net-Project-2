<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSpeak.aspx.cs" Inherits="Mastercraft.Admin.StudentSpeak" %>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3> Text Edit</h3>
          		...
          		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Text">
                              <EditItemTemplate>
                            <asp:TextBox ID="Text" Text="<% # Bind('Text')%>" runat="server"></asp:TextBox>
			...
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  DeleteCommand="DELETE FROM [aismtc_student_speak] WHERE [id] = @id" 
                  InsertCommand="INSERT INTO [aismtc_student_speak] ([page_name], [writer], [text]) VALUES (@page_name, @writer, @text)" 
                  ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
                  SelectCommand="SELECT [id], [page_name], [writer], [image_url], [text] FROM [aismtc_student_speak]" 
                  UpdateCommand="UPDATE [aismtc_student_speak] SET [page_name] = @page_name, [writer] = @writer, [image_url] = @image_url, [text] = @text WHERE [id] = @id">
                  <DeleteParameters>
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
          ...
          <Columns>
              ...
              <asp:HyperLinkField DataNavigateUrlFields="id" 
                  DataNavigateUrlFormatString="edit_stuednt_text_master.aspx?id={0}" 
                  Text="Edit" />
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ConnectionString="<%$ ConnectionStrings:PriyamarketingConnectionString1 %>" 
          DeleteCommand="DELETE FROM [aismtc_student_speak] WHERE [id] = @id" 
          InsertCommand="INSERT INTO [aismtc_student_speak] ([page_name], [writer], [image_url], [text]) VALUES (@page_name, @writer, @image_url, @text)" 
          ProviderName="<%$ ConnectionStrings:PriyamarketingConnectionString1.ProviderName %>" 
          SelectCommand="SELECT [id], [page_name], [writer], [image_url], [text] FROM [aismtc_student_speak]" 
          UpdateCommand="UPDATE [aismtc_student_speak] SET [page_name] = @page_name, [writer] = @writer, [image_url] = @image_url, [text] = @text WHERE [id] = @id">
          <DeleteParameters>
