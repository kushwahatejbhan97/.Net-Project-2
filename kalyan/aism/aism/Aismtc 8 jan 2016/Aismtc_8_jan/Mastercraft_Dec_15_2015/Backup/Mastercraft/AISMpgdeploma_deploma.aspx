<%@ Page Title="" Language="C#" MasterPageFile="~/Courses.Master" AutoEventWireup="true" CodeBehind="AISMpgdeploma_deploma.aspx.cs" Inherits="Mastercraft.AISMpgdeploma_deploma" %>
...
<div class="vikwidget_right ">
                ...
                <div class="vikheader" >
        <div class="" style=" ">
            <h4 style="font-size:20px;font-weight:600;margin-left:20px; color:Navy;">PG Deploma & Deploma</h4>
        ...
        SelectCommand="SELECT [id], [page_name], [header], [collapseOne], [text] FROM [aismtc_packages] WHERE  [page_name]='PG Deploma & Deploma' "
