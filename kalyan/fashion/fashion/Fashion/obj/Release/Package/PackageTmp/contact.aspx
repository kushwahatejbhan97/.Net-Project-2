<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="/contact.cs" Inherits="fashion.contact" %>
        ...
        <div class="row top-map">
          <div class="col-lg-6 partners">
            <div class="cont-details">
              <h3 class="hny-title mb-0">Diviniti <span>Services</span> Center</h5>
              <p class="mb-5">We're ready to lead you into the future with Business Services</p>
              <p class="margin-top"><span class="texthny">Call Us : </span> <a href="tel:+1800 3133395">+1800 3133395</a></p>
              <p> <span class="texthny">Email : </span> <a href="mailto:helpline@brep.in">
                  helpline@brep.in</a></p>
              <p class="margin-top">6-3-648, Ground Floor, Padmaja landmark Somajiguda, Hyderabad Telangana-500082 </p>
            </div>
            <div class="hours">
