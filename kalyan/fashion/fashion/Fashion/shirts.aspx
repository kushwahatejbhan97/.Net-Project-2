<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="shirts.aspx.cs" Inherits="fashion.tshirts" %>
            ...
            <ul class="portfolio-area clearfix p-0 m-0">
                <li class="portfolio-item2 content" data-id="id-1" data-type="cat-item-1">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/shirts/1.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/1.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                ...
                <li class="portfolio-item2 content" data-id="id-2" data-type="cat-item-2">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/shirts/2.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/2.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-3" data-type="cat-item-1">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/shirts/3.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/3.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-4" data-type="cat-item-3">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href=imgs/shirts/4.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/4.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-5" data-type="cat-item-4">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/shirts/5.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/5.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-7" data-type="cat-item-3">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/shirts/6.jpg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/shirts/6.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
