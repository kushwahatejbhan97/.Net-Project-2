<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="tshirts.aspx.cs" Inherits="fashion.tshirts1" %>
            ...
            <ul class="portfolio-area clearfix p-0 m-0">
                <li class="portfolio-item2 content" data-id="id-1" data-type="cat-item-1">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/tshirts/1.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/1.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                ...
                <li class="portfolio-item2 content" data-id="id-2" data-type="cat-item-2">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/tshirts/2.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/2.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-3" data-type="cat-item-1">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/tshirts/3.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/3.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-4" data-type="cat-item-3">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href=imgs/tshirts/4.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/4.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-5" data-type="cat-item-4">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/tshirts/5.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/5.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
                ...
                <li class="portfolio-item2 content" data-id="id-7" data-type="cat-item-3">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="imgs/tshirts/6.jpeg" data-gal="prettyPhoto[gallery]">
                            <div class="content-overlay"></div>
                            <img src="imgs/tshirts/6.jpeg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title"></h3>
