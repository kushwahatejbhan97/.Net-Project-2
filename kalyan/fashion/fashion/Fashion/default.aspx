<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="fashion._default" %>
							...
							<div class="container">
								<div class="carousel-caption">
									<h3>Men's
										Fashion
										<br>50% Off</h3>
									<a href="/shirts" class="shop-button btn">
										Shop Now
									</a>
...
<section class="w3l-grids-hny-2">
	...
	<div class="grids-hny-2-mian py-5">
		<div class="container py-lg-5">
			...
			<h3 class="hny-title mb-0 text-center"> Check <span>Our </span>Brands</h3>
			<p class="mb-4 text-center"></p>
			<div class="welcome-grids row mt-5">
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/shirts">
                                    <img src="imgs/shopwithus/1.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More
								</div>
							</a>
						</div>
						<h4><a href="/shirts">shirts</a></h4>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/jeans">
										<img src="imgs/shopwithus/2.jfif" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More</h3>
								</div>
							</a>
						</div>
						<h4><a href="/jeans">jeans</a></h4>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/tshirts">
										<img src="imgs/shopwithus/3.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More</h3>
								</div>
							</a>
						</div>
						<h4><a href="/tshirts">T-Shirts</a></h4>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/shorts">
										<img src="imgs/shopwithus/4.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More</h3>
								</div>
							</a>
						</div>
						<h4><a href="/shorts">Shorts</a></h4>

				</div>
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/joggers">
										<img src="imgs/shopwithus/5.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More</h3>
								</div>
							</a>
						</div>
						<h4><a href="/joggers">Joggers</a></h4>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="/trousers">
										<img src="imgs/shopwithus/6.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">View More</h3>
								</div>
							</a>
						</div>
						<h4><a href="/trousers">Trousers</a></h4>
			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-right col-lg-6">
								<h3 class="hny-title text-left">All Branded Men's shirts are Flat <span>30% Discount</span></h3>
...
<section class="w3l-ecommerce-main">
	...
	<div class="ecom-contenthny py-5">
		<div class="container py-lg-5">
			<h3 class="hny-title mb-0 text-center">OUR <span>COLLECTIONS</span></h3>
			...
			<div class="content-info-in row">
				<div class="content-gd col-md-6 offset-lg-3 text-center">
					...
					<p>Diviniti has proven itself to be one of the premier sources of vision and innovation for consumer electronics. 
						Founded in 2013, Diviniti has engaged in offering quality home entertainment products, . As a mission to enhance our
						life enjoyment from day to day, Diviniti combines advanced technology with its unique expertise in consumer electronics to 
						create value-added solutions in the market. Dedicated to the integration of sound and picture in the home environment, portfolio
						includes high definition LED TVs, Home Theatre Systems, Car Audio, Washing Machines and other Home Appliances.</p>
					<a href="/electronics" class="read-more-btn2 btn">
						Shop Now
					</a>
		...
		<div class="container py-lg-5">
			...
			<div class="post-hny-grids row mt-5">
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="/electronics">
						<figure>
                            <img src="imgs/leds/led4kHead.jpg" alt="blog-image">
						</figure>
					</a>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="/electronics">
					<figure>
                        <img src="imgs/leds/LEDTV!.jpg" alt="blog-image">
					</figure>
					</a>
				</div>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="/electronics">
                        ...
                        <img src="imgs/leds/Nik-cat-6.jpg"  alt="blog-image">
					</figure>
					</a>
				</div>
          ...
          <div class="container py-lg-5">
              <div class="text-txt row">
                  <div class="left-side col-lg-4">
                     <%-- <h3><a class="logo-footer" href="default.aspx">
                  ...
                  <div class="right-side col-lg-8 pl-lg-5">
                      ...
                      <div class="sub-columns">
                          ...
                          <div class="sub-two-right">
                              ...
                              <p class="mb-5"></p>
							<p class="margin-top"><span class="texthny">Call Us : 1800 3133395  </span> </p>
							  <a style="color:white" href="mailto:Care@diviniti.net.in"> Email :   Care@diviniti.net.in</></a>
              ...
              <%--<div class="below-section row">
                  ...
                  <div class="columns col-lg-6 text-lg-right">
                      <%--<p>© 2020 Sp. All rights reserved. Design by <a href="https://www.dexterous.in/Best-mobile-app-development-company-in-Hyderabad" target="_blank">
