<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginCheckout.aspx.cs" Inherits="DecoratinComplete.LoginCheckout" %>
...
<!-- //Modal2 -->
  ...
  <div runat="server" id="itemcart"  class="modal-dialog modal-lg" role="document" style="margin-top: 81px;">
        ...
        <h5 class="modal-title" id="exampleModalLabel">
		  ...
		  <div class="discount-token-new">
            ...
            <div class="wrapper-flex">
				...
				<asp:Label ID="txtAddress" style=" width:90%; padding:8px;"  CssClass="input-default" runat="server"></asp:Label>
              <%--<input type="text" name="discount-token" id="discount-token" class="input-default"/>--%>
				<%--<asp:Button ID="BtnChangeAdd" CssClass="btn btn-outline" runat="server" Text="Change" />--%>
				
				 <%--<asp:Button ID="BtnAddChange" CssClass="btn btn-outline"  style=" width: 10%"  runat="server" Text="Change"  OnClick="BtnAddChange_Click" />--%>
      ...
      <section class="cart">
        ...
        <div class="wrapper">
          ...
          <div class="amount">
            ...
            <div class="subtotal">
              <span>Subtotal</span> <span>$ <span id="subtotal" runat="server">0.00</span></span>
            </div>

            <div class="tax">
              <span>GST</span> <span>$ <span id="tax" runat="server">0.00</span></span>
            </div>

            

            <div class="total">
              <span>Total</span> <span>$ <span id="total" runat="server">0.00</span></span>
            </div>
			  ...
			  <label for="discount-token" class="label-default" style="background:#fff7f708; text-align:center; padding-top:4%; color:#d9534f;">Min order amount (before tax and shipping): $300</label>
