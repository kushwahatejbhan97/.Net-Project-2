...
{
    public partial class LoginSingle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    urlredirect = "/product/" + ProductUrl;
        ...
        protected void databindme()
        {
            try
            {
                ...
                try
                {
                    ...
                    Price.InnerHtml = "<span class='item_price' style='color: #fc636b;'>" + "$" + ArrPrductData[11].ToString() + "</span>";
                    Price.Visible = true;
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                Price.InnerHtml = "<span class='item_price' style='color: #fc636b;'>" + "$" + packInfoData[0].ToString() + "</span>";
                Price.Visible = true;
