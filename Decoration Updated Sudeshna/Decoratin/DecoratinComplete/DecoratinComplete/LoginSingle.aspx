<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginSingle.aspx.cs" Inherits="DecoratinComplete.LoginSingle" %>
...
<!-- //Modal2 -->
            ...
            <div class="container">
                    ...
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                           ...
                           <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDbLeftImg" runat="server" ConnectionString="<%$ ConnectionStrings:HandicraftAustralia %>" SelectCommand="SELECT [ProductSizeId], [Dimensions], [Weight], [Stock], [StocktoDispatch], [Discount], [Status], [MRP], [Price], [MinQuantity], [ProductSizeLabel], [ProductId], [ProductSizeImgMbl], [ProductSizeImgDesk], [ProductSizeSlider] FROM [ProductSize] WHERE ([ProductSizeId] = @ProductSizeId)">
                                    <SelectParameters>
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    ...
                    <SelectParameters>
                        ...
                        <%--<div class="colr">
                            <label class="radio">
                                <input type="radio" name="radio"><i></i>Sneakers
                            </label>
                        </div>--%>
					...
					<div class="row" style="width:50%">
						<div class=" color-quality-right">
												<div id="DivAddBtn" runat="server"  class="col-md-6 inner-men-cart-pro">
													<asp:LinkButton ID="LbtnAddToCart" ValidationGroup="SingleProduct"  CssClass="link-product-add-cart" runat="server" Text="Add To Cart" OnClick="LbtnAddToCart_Click"  ></asp:LinkButton>	
												</div>
     ...
     <input type="text" readonly="readonly" id="qty_display1" class="qty-input text-center center-quantity"  value='<%# Eval("NoOfItems") %>' />
	   ...
	   <asp:LinkButton ID="LbtnIncrement1"  CssClass="right-decrease" runat="server" CommandName="Increase" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-plus" style="color:#fff;" ></i></asp:LinkButton>
                    ...
                    <!--//tab_one-->
					<%--<asp:Repeater ID="Repeaterproducttype1" runat="server" DataSourceID="SQLdbProductType1">
                        <HeaderTemplate>
                            <div class="tab1">
                        </HeaderTemplate>
                        <ItemTemplate>
                            ...
                            <div class="col-md-3 product-men">
                                ...
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        ...
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                            <asp:Button ID="BtnAddToCart1" CssClass="button" runat="server" Text="Add To Cart" CommandName="Add" CommandArgument='<%# Eval("ProductSizeId") + ";" + Eval("ProductId") + ";" +  Eval("ProductName")  + ";" + Eval("CatId")   + ";" + Eval("Material")   + ";" + Eval("Color")   + ";" + Eval("Dimensions")   + ";" + Eval("Stock")   + ";" + Eval("MRP")   + ";" + Eval("Price")   + ";" + Eval("MinQuantity")    + ";" + Eval("Discount")  + ";" + Eval("ProductSizeImgMbl") %>' />
                    ...
                    <asp:SqlDataSource ID="SQLdbProductType1" runat="server" ConnectionString="<%$ ConnectionStrings:HandicraftAustralia %>"
                        SelectCommand="SELECT top(8) [ProductId], [ProductName], [Url], [Title], [KeyWords], [Description], [Details], [CatId], [CatName], [Color], [Type], [Material], [Theme], [SuitableFor], [Trending], [Offers], [Recommends], [Status], [Ratings], [Brand], [ProductSizeId], [Dimensions], [Weight], [Stock], [StocktoDispatch], [Discount], [MRP], [Price], [MinQuantity], [ProductSizeLabel], [ProductSizeImgMbl], [ProductSizeImgDesk], [ProductSizeSlider] FROM [Product] Where [CatId]='18' and [ProductSizeLabel]='New' order by newid()"></asp:SqlDataSource>--%>
