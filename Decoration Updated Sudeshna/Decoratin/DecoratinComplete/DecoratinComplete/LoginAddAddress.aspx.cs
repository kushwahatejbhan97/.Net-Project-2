...
{
    public partial class LoginAddAddress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    txtEditPostalPIN.Text = ClientData[5].ToString();
                    txtEditAddress.Text = ClientData[4].ToString();
                    ...
                    try
                    {
                        ...
                        //if (Session["ClientId"] == null)
                        //{
                        //    signinUpForm.Visible = true;
                        //    productCartVisibe.Visible = false;
                        //}
                        //else
                        //{
                        //    signinUpForm.Visible = false;
        ...
        //        //int ABN = int.Parse(TxtSignUpABN.Text);
        ...
        //                           "alert('Successfully Inserted.'); window.location='" + "Demo.aspx';", true);
        //    }
        ...
        protected void BtnPlaceOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Double tax = .10;
                Double Shipping = 5.5; //DeliveryCharge
        ...
        protected void BtnAddContinue_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String PostalPIN = txtEditPostalPIN.Text;
                String Address = txtEditAddress.Text;

                dalclass.UpdateClientData(ClientID, PostalPIN, Address);
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect",
                                   "alert('Successfully Updated.'); window.location='" + "/address';", true);
            }
