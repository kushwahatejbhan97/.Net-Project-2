<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="DecoratinComplete.Order" %>
         ...
         <!-- mens -->
			...
			<%--<div class="col-md-8 products-right" style="margin-top:30px;" >
				...
				<div class="modal-content1">
						...
						<h3 class="agileinfo_sign">My <span>Order</span></h3>
							...
							<asp:Button ID="BtnUpdate" runat="server" ValidationGroup="SignUp" Text="Update"   />

						
						  
														<div class="clearfix"></div>
							<div class="check_box" style="margin-top:15px;">
							
							<asp:CheckBoxList ID="CheckBoxList2" CssClass="my-radio-list" runat="server">
							<asp:ListItem>By clicking register, I agree to your terms</asp:ListItem>
        ...
        <div class="forms">
            ...
            <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                ...
                <div class="form-body" style="overflow-x: scroll;">
                    ...
                    <asp:GridView ID="GridView1" CssClass="table table-bordered table-striped no-margin grd_tble" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderId" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display.">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ProductCount" HeaderText="Total Product" SortExpression="ProductCount" />

<%--							<asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("OrderId", "loginOrderHistory.aspx?orderid={0}") %>' >
										<i class="fa fa-eye" aria-hidden="true" style="background: #947f57;
    color: white;
    font-size: 14px;
    padding: 8px;" ></i>
