<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="/.cs" Inherits="DecoratinComplete.Default" %>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign Up <span>Now</span></h3>
							...
							<asp:Button ID="BtnSignUpSunmit" runat="server" ValidationGroup="SignUp" Text="Sign Up"  />
	...
	<div class="new_arrivals_agile_w3ls_info"> 
     ...
     <input type="text" readonly="readonly" id="qty_display1"  class="qty-input text-center center-quantity"  value='<%# Eval("NoOfItems") %>' />
	   ...
	   <asp:LinkButton ID="LbtnIncrement1" CssClass="right-decrease" runat="server" CommandName="Increase" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-plus" style="color:#fff;" ></i> </asp:LinkButton>
						...
						<%--<asp:UpdateProgress ID="UpdateProgress3" runat="server" DynamicLayout="true" AssociatedUpdatePanelID="UpdatePanel2">
						<progresstemplate>
						  <div style=" width: 100%; position:fixed; top:125px; right:10px;   z-index:9999999999999;">
							 <div class="center">
							 <center><img src="/images/loading-min.gif" alt="loading..." class="img-responsive" style="width:60px;" /></center>  
							  </div>
						   </div>
						</progresstemplate>
					</asp:UpdateProgress>--%>
			...
			<asp:LinkButton ID="LinkButton2"  CssClass="left-decrease" runat="server" CommandName="Decrease" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-minus" style="color:#fff;" ></i></asp:LinkButton>
	

   
     <input type="text" readonly="readonly" id="qty_display2"  class="qty-input text-center center-quantity"  value='<%# Eval("NoOfItems") %>' />
		



	   <asp:LinkButton ID="LbtnIncrement2" CssClass="right-decrease" runat="server" CommandName="Increase" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-plus" style="color:#fff;" ></i> </asp:LinkButton>
			...
			<asp:LinkButton ID="LinkButton3"  CssClass="left-decrease" runat="server" CommandName="Decrease" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-minus" style="color:#fff;" ></i></asp:LinkButton>
     ...
     <input type="text" readonly="readonly" id="qty_display1"  class="qty-input text-center center-quantity"  value='<%# Eval("NoOfItems") %>' />
	   ...
	   <asp:LinkButton ID="LbtnIncrement3" CssClass="right-decrease" runat="server" CommandName="Increase" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-plus" style="color:#fff;" ></i> </asp:LinkButton>
			...
			<asp:LinkButton ID="LinkButton4"  CssClass="left-decrease" runat="server" CommandName="Decrease" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-minus" style="color:#fff;" ></i></asp:LinkButton>
     ...
     <input type="text" readonly="readonly" id="qty_display1"  class="qty-input text-center center-quantity"  value='<%# Eval("NoOfItems") %>' />
	   ...
	   <asp:LinkButton ID="LbtnIncrement4" CssClass="right-decrease" runat="server" CommandName="Increase" CommandArgument='<%# Eval("ProductSizeId")%>'><i class="fa fa-plus" style="color:#fff;" ></i> </asp:LinkButton>
