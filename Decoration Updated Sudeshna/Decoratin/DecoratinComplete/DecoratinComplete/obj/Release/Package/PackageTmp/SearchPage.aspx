<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchPage.aspx.cs" Inherits="DecoratinComplete.SearchPage" %>
        ...
        <table class="table table-image" >
          <thead > 
			...
			<asp:UpdatePanel ID="UpdatePanel5" runat="server">
			  ...
			  <asp:Repeater ID="RepeaterCart" runat="server" OnItemCommand="Repeaterproducttype1_ItemCommand" visible="True">
 ...
 <div class="d-flex flex-row align-self-center product_data"  id="qty_select">
   ...
   <div class="input-group text-center" id="qty_selector">
	   <asp:LinkButton ID="LbtnDecrement" CssClass="decrement-btn" runat="server" CommandName="Decrease" CommandArgument='<%# Eval("ProductSizeId")%>'>
		   <i class="fa fa-minus" style="padding-left:20%"></i>
	   </asp:LinkButton>
