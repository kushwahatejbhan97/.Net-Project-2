<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="DecoratinComplete.Register" %>
			...
			<div class="col-md-8 products-right" style="margin-top:30px;" >
				...
				<div class="modal-content1">
						...
						<h3 class="agileinfo_sign">Sign Up <span>Now</span></h3>
							...
							<div class="styled-input ">
								 <asp:TextBox ID="txtBusinessDes" TextMode="MultiLine" runat="server"></asp:TextBox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="SignUp" ControlToValidate="txtBusinessDes" runat="server" ForeColor="Red" ErrorMessage="Describe Your Business"></asp:RequiredFieldValidator>
								<label>Describe Your Business in Brief</label>
								<span></span>
