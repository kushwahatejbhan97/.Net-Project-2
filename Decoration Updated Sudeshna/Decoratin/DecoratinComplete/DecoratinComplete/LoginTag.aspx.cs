...
{
    public partial class LoginTag : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    string tagSearch = Page.RouteData.Values["tagSearch"].ToString();
                    urlredirect = "/tag/" + tagSearch;
        ...
        protected void databindme()
        {
            try
            {
                ...
                try
                {
                    ...
                    String tag = Page.RouteData.Values["tagSearch"].ToString();
                    HeadTitle.InnerText = "Search Reault for  " + tag;
                    HeadsubTitle.InnerText = tag;
                    DataTable CategoryTable1 = dalclass.TagDataFillbySearch(tag);
        ...
        protected void FilterChange(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable CategoryTable1 = dalclass.ProductDataFillbyCatSearch(query);
                Repeaterproducttype1.DataSource = CategoryTable1;
                Repeaterproducttype1.DataBind();
                int ProductCount = Repeaterproducttype1.Items.Count;
        ...
        protected void BtnSignUpSunmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect",
                                   "alert('Successfully Inserted.'); window.location='" + "Tag.aspx';", true);
            }
