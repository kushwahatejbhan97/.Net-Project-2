...
{
    public partial class loginCategory : System.Web.UI.Page
    {
        ...
        protected void databindme()
        {
            try
            {
                ...
                {
                    string caturl = Page.RouteData.Values["CatUrl"].ToString();
                    HeadTitle.InnerText = caturl;
                    HeadsubTitle.InnerText = caturl;
                    int catId = dalclass.getCatidbyUrl(caturl);
                    DataTable CategoryTable1 = dalclass.ProductDataFillbycatagory(catId);
