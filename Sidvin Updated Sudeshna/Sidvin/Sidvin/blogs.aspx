<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blogs.aspx.cs" Inherits="Sidvin.blogs" %>
          ...
          <div class="container">
              <%--<asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                                ...
                                <div class="col-lg-4 col-sm-6 team-block " >
                                      <a href="vlogdetails/<%# Eval("Id") %>">
                        <div class="team-block-single">
                            <div class="team-grids">
                              
                                    
                                    <img src="/Admin/Blog/Desktop/<%# Eval("DeskImgUrl") %>" class="img-fluid " style="height: 250px;" alt=""/>
                                  
                               
                            </div>
                            <div class="team-bottom-block p-4" >
                               
                              <h6 class="blogheading"><%# Eval("Header") %></h6>
                                  <span><%# Eval("Date") %></span>
                            </div>
            ...
            <div class="row my-3">
              ...
              <div class="col-lg-6 col-12 blog-img-section">
                <img
              ...
              <a href="blogdetails/<%# Eval("BlogId") %>"  class="btn btn-primary btn-style mt-md-5 mt-4">
