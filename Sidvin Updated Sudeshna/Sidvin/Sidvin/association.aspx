<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="association.aspx.cs" Inherits="Sidvin.association" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <body>
    ...
    <div class="breadcrumb-bg breadcrumb-bg-associations py-5">
  ...
  <section class="w3l-breadcrumb">
    <div class="container">
      <ul class="breadcrumbs-custom-path">
        ...
        <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Association</li>
      </ul>
    </div>
  </section>
    <section class="association ">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/45_Bulletin_Of_Builders_Association_Of_India.png"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/aimym_logo.png"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/GRA LOGO ZOOM.png"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/lionlogo_2c.jpg"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/NAR-INDIA Final logo (1).png"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/NHRCCB.jpg"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/PcJ8Drpi.jpg"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/RAI_Logo.png"
              alt=""
              class="img-fluid"
            />
          </div>
          <div class="col-md-6 col-12 col-lg-3 p-5">
            <img
              src="assets/images/association/Association Logo.png"

               <%-- <img src="assets/images/association/Association Logo.png" />--%>
              alt=""
              class="img-fluid"
            />
          </div>
