<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vlogs.aspx.cs" Inherits="Sidvin.vlogs" %>
...
<section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-vlogs py-5">
        <div class="container py-lg-5 py-md-3">
            <h2 class="title">World of Vlogs</h2>
        </div>
    </div>
</section>
<section class="w3l-breadcrumb">
    <div class="container">
        <ul class="breadcrumbs-custom-path">
            ...
            <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>vlogs</li>
        </ul>
    </div>
</section>
...
<section class="w3l-bottom-grids-6 py-5 vlogs-section" id="vlogs">
    <div class="container py-lg-5 py-md-4">
        <!-- <h6 class="title-small text-center text-light">--- By Vikas Goenka ---</h6> -->
        <h3 class="title-big mb-md-5 mb-4 text-center text-white">--- By Vikas Goenka --- </h3>
        <div class="grids-area-hny main-cont-wthree-fea row">
            <div class="col-lg-4 col-md-6 grids-feature">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/hC3QQlCe01U">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-9.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/yoYfllrnWkE">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-8.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/iSeOLGr0ZIQ">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-1.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/cwDGVvaQZ7k">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-2.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/_e3oXCgofbg">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-3.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/izmINSE2c74">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-4.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/jyUmEaYHwTs">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-5.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/MxhzYBARXys">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-6.png" alt="">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                <div class="area-box">
                    <a class="vlog-img img-fluid vid-link" href="#" data-toggle="modal" data-target="#videoModal" data-vidLink="https://www.youtube.com/embed/GRX0uYt_qE0">
                      <img class="img-fluid" src="assets/images/video-thumbs/vlog-7.png" alt="">
                    </a>
                </div>
            </div>
        </div>
