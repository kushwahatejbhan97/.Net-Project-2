<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portfolio.aspx.cs" Inherits="Sidvin.portfolio" %>
 ...
 <head>
  ...
  <body>
    ...
    <section class="w3l-about-breadcrumb">
      <div class="breadcrumb-bg breadcrumb-bg-portfolio py-5">
    ...
    <section class="portfolio-section container-fluid mb-5 mt-3">
      <div class="container">
        <div class="about_tabs">
          <button
            class="tablink"
            onclick="openPage('Completed', this)"
            id="defaultOpen"
          >
            Completed
          </button>
          <button class="tablink" onclick="openPage('Upcoming', this )">
            Upcoming
          </button>
        </div>
        <div id="Completed" class="tabcontent">
          <div class="mt-4">
            <h4 style="font-weight: 600; color: #b31010">Completed</h4>
            <h4 style="font-weight: 600; color: #b31010">____________</h4>
          </div>
          <div class="testimonial-video-grid mb-5">
            ...
            >
              <img
               ...
               src='/Admin/blogs/Desktop/<%# Eval("image") %>'
                alt=""
              />
                 <span style="color: black; font-weight: 600;text-justify:none;">  <%# Eval("Header") %></span>
            </a>
                       </ItemTemplate>
           </asp:Repeater>
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sidvin %>" SelectCommand="SELECT [ProjectId], [Type], [image], [Header] FROM [Project] Where Type='1'"></asp:SqlDataSource>
          </div>
        </div>
        <div id="Upcoming" class="tabcontent">
          <div class="mt-4">
          <h4 style="font-weight: 600; color: #b31010">Upcoming</h4>
          <h4 style="font-weight: 600; color: #b31010">____________</h4>
        </div>
        <div class="testimonial-video-grid">
          ...
          >
           ...
           src='/Admin/blogs/Desktop/<%# Eval("image") %>'
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sidvin %>" SelectCommand="SELECT [ProjectId], [Type], [image], [Header] FROM [Project] Where Type='2' "></asp:SqlDataSource>
        </div>
        </div>
      </div>
    </section>
