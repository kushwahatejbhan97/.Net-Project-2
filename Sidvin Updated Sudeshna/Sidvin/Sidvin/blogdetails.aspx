<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blogdetails.aspx.cs" Inherits="Sidvin.blogdetails" %>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item ml-3">
                <a href="/contact" class="btn btn-outline-primary btn-style text-uppercase mr-2">Contact Us</a>
              </li>
            </ul>
      ...
      <div class="row">
        <div class="col-12">
          <div class="blog-title">
            <h4 id="Header" runat="server" class="title-big"></h4>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="blog-img">
            <img id="imageblog" runat="server" class="img-fluid" src="" alt="" />
          </div>
        ...
        <div class="col-12 mt-0 mt-md-4 col-md-4">
          <div class="r-blog-img">
            <img src='/Admin/blogs/Desktop/<%# Eval("Image") %>' alt="">
          </div>
          <div class="r-blog-content">
            <h4 class="small-title">   <%# Eval("Header") %></h4>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sidvin %>" SelectCommand="SELECT [BlogId], [Image], [Subject], [Content], [Date], [Header] FROM [Blog]"></asp:SqlDataSource>
         </div>
  </section>
