<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="AppMyDeal.Category" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <img src='/upload_tag/icon/<%# Eval("CatIConImageID") %>.jpg' alt="service" class="img-fluid" style="border-radius: 100%;" />
                                      ...
                                      <p class="para-design"> <%# Eval("Tags") %> </p>
