                       ...
                       <div class=" col-md-4">
                        <label style="color:White;">Company</label>
                            <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" AutoPostBack="true" 
                                DataSourceID="SqlDataSourceListType" DataTextField="CompanyName" DataValueField="CompanyId">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceListType" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:PriyamarketingConnectionString %>" 
                                SelectCommand="SELECT DISTINCT [CompanyId], [CompanyName] FROM [NewListing_Website_listing_tbl]">
                            </asp:SqlDataSource>
                       </div>
                    </div>
                    ...
                    <div  class="form-horizontal" >
                      ...
                      Text="Manage" HeaderText="Action" ControlStyle-CssClass="btn btn-primary" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [CompanyId], [CatId], [CompanyName], [OwnerName], [YearEstablish], [Mobile], [LandLine], [Email], [Website], [Location], [Address], [City], [Map], [RegsitrationDate], [KeyWord], [Enable], [TotalReview], [url], [Password], [Priority], [ListingType] FROM [NewListing_Website_listing_tbl] WHERE (([CatId] = @CatId) AND ([City] = @City) AND  ([CompanyId] = @CompanyId))">
                                <SelectParameters>
