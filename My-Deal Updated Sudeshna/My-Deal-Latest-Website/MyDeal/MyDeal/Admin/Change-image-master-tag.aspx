                      ...
                      <table class="table table-bordered table-condensed" >
                        ...
                        <tbody>
                            <tr>
                               ...
                               <%-- <td><img src='/upload_tag/icon/<%=Server.UrlDecode(Request.QueryString["CatIConImageID"]) %>.jpg' style="height:120px; width:200px" /></td>--%>

                                 <td>
                                    <asp:Image ID="Image1"  runat="server" Width="200" Height="120" /></td>
