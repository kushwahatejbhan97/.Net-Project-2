<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MyDeal.Default" %>
            ...
            <div class="wrapper">
                ...
                <div class="right-models text-center">
                    <div class="d-grid grid-sec">
                        ...
                        SelectCommand="SELECT TOP 24 [Catid], [CategoryName], [Priority], [EnableBottom], [urlc], [CatIConImageID], [CatImageID] FROM [NewListing_Website_category_tbl] ORDER BY CategoryName">
