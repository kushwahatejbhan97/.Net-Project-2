<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewFreeListingRegs.aspx.cs" Inherits="MyDeal.NewFreeListingRegs" %>
                    ...
                    <div class="about-right-faq">
                        ...
                        <div class="ele-9its_grid">
                         ...
                         <div class="d-grid grid">
                            ...
                            <div class="ele-9its_grid">
                                   <asp:CheckBoxList ID="CheckBoxList1"  runat="server" DataSourceID="SqlDataSourceTagsName" DataTextField="Tags" RepeatDirection="Horizontal" RepeatColumns="5"  DataValueField="Tags" ValidationGroup="NewListing">
                                        </asp:CheckBoxList>
