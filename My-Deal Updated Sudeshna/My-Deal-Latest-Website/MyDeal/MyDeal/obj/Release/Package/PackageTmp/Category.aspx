<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="MyDeal.Category" %>
...
<body>
    ...
    <section class="w3l-category-main">
        <div class="categories-sec">
            <div class="wrapper">
                <h3 class="title-main">Popular Tags</h3>
                <div class="right-models text-center">
                    <div class="d-grid grid-sec">
                         <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDbPopulartag">
                             <ItemTemplate>
                        <a href="/tag/<%# Eval("Tags") %>">
                            <div class="card">
                                <div class="card-body">
                                   <%-- <span class="fa fa-bed"></span>--%>
                                   <img src='/upload_tag/icon/<%# Eval("CatIConImageID") %>.jpg' alt="service" class="img-fluid" style="border-radius: 100%;" >
                                       <%-- <img src="uploads/23000.jpg" class="img-fluid" style="border-radius: 100%;" />--%>
                                    <h5 class="card-title mt-4"><%# Eval("Tags") %> </h5>
                        ...
                        <asp:SqlDataSource ID="SqlDbPopulartag" runat="server" ConnectionString="<%$ ConnectionStrings:PriyamarketingConnectionString %>" 
                        SelectCommand="SELECT [TagId], [Catid], [Tags],[urlt], [CatIConImageID] FROM [NewListing_Website_tags_tbl] ORDER BY TagId DESC">
               ...
               <%-- <h1>Shopping Cart</h1>--%>
                <div class="shopping-cart">
                    ...
                    <asp:SqlDataSource ID="SqlDblistingData" runat="server" ConnectionString="<%$ ConnectionStrings:PriyamarketingConnectionString %>" 
                        ...
                        SelectCommand="SELECT [CompanyId], [CompanyName], [Mobile], [Password], [VerMobile], [CatId], [OwnerName], [YearEstablish], [LandLine], [Email], [Website], [Location], [Address], [City], [Map], [RegsitrationDate], [KeyWord], [Enable], [TotalReview], [Latitude], [Longitude], [url], [ListingType], [Priority], [Tags], [ListingImageID], [CatName] FROM [NewListing_Website_listing_tbl] WHERE ([CatName] LIKE  %@CatName%)" >
                        
                     <SelectParameters>
                                        <asp:QueryStringParameter DefaultValue="0" Name="CatName" QueryStringField="CatName" Type="String" />
                                    </SelectParameters>
                    </asp:SqlDataSource>
