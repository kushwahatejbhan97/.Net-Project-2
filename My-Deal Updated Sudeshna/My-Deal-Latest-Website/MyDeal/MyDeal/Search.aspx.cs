    ...
    public partial class Search : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string city = Page.RouteData.Values["city"].ToString();
                string caturl = Page.RouteData.Values["category"].ToString();
                int catId = dalclass.getCatidbyUrl(caturl);
                DataTable ListingTable = dalclass.SelectCompnyBykeysearch(keysearch, city, catId);
