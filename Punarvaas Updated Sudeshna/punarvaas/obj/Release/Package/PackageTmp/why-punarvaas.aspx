...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="why-punarvaas.aspx.cs" Inherits="punarvaas.why_punarvaas" %>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item  mr-3 active">
                            <a class="nav-link text-white text-capitalize active" href="/why-punarvaas">Why Punarvaas</a>
                        </li>
                        <li class="nav-item  mr-3 ">
            ...
            <div class="title-section text-center pb-md-5">
               <span style="color:#00aea5;font-size:30px;font-weight: 900;">Punar</span><span style="color:#606165;font-size:30px;font-weight: 900;">vaas</span>
                ...
                <div class="col-md-12 team-text mt-md-0 mt-5">
                    ...
                    <p class="my-3">Punarvaas has a well-trained team that will guide you and helps you heal in a place that is a home away from home. Our healing program includes:
                    </p>
                  <ul class="list-group mt-3">
                        <li class=" list" style="color:#777">
                           Follows the well-tried and tested, world-renowned techniques and programs for drug rehabilitation</li>
                        <li class="list" style="color:#777">
                         Programs include both individual and family therapy</li>
                      <li class=" list" style="color:#777">
                           Holistic therapy that includes exercise and meditation</li>
                      <li class=" list" style="color:#777">
                          Guide you to help you rebuild your relationships with your loved ones</li>
                      <li class=" list" style="color:#777">
                          Programs include ways that will immensely help you improve both your physical as well as mental health</li>
                      <li class=" list" style="color:#777">
                           Intensive relapse prevention program</li>
                        </ul>
 ...
 Our mission is to train each & every one of them to live a life filled with happiness and contentment. Our program motivates our brothers to rebuild their lives and carry out their duties towards their families and society with utmost sincerity.
    ...
    <section class="blog_w3ls py-lg-5" style="background: #2b3d5c;">
        <div class="container">
            <div class="title-section text-center pb-lg-5">
                <h4></h4>
                <h3 class="w3ls-title text-center text-capitalize"style="color:#fff">What is drug addiction?</h3>
            </div>
            <div class="row mt-5 pb-lg-5">
                <div class="col-md-4 border p-0 my-auto">
                    <img   src="/img/what%20is%20drug%20addiction.jpg"  class="img-fluid" alt="team-img" />
                </div>
                <div class="col-md-8 team-text mt-md-0 mt-5">
                    
                    <p class="my-3" style="color:#fff">Drug addiction is a psychological condition where a person is no longer able to control the urge to consume drugs. They become dependent and have a compulsive need to take drugs no matter the effect that it has on their physical or mental well-being. Their relationships are strained as they only care about getting their next fix.
</p>
    ...
    <section class="blog_w3ls py-lg-5">
        <div class="container">
            <div class="title-section text-center pb-lg-5">
                <h4></h4>
                <h3 class="w3ls-title text-center text-capitalize">Why Place Your Recovery in Our Hands?</h3>
            </div>
            <div class="row mt-5 pb-lg-5">
                
                <div class="col-md-8 team-text mt-md-0 mt-5">
                    
                    <p class="my-3">Fighting any form of addiction requires dedication and determination. Expert care and adequate facilities are very important to make the process convenient and effective.
                                ...
                                <div class=" ">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button headingFAQ collapsed faqdropdown" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                            1.	What types of drugs are treated in Punarvaas?
                                        </button>
                                    </h2>
                                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body mb-2 faqanswers">We treat almost all kinds of drug abuse here. Please contact us so that we can give you further information.</div>
                                    </div>
                                </div>
                                <div class="">
...
Trauma - It is often seen that people often resort to drugs to escape unpleasant physical or mental trauma. They find drugs to give them the temporary euphoria that they consider ‘happiness’.  Soon the quantity they require to get this feeling increases and before they know it, they are already addicted.
                                ...
                                <div class="">
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button class="accordion-button headingFAQ collapsed faqdropdown" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                                         3. What are the ways to deal with the initial stages of drug addiction?
                                        </button>
                                    </h2>
