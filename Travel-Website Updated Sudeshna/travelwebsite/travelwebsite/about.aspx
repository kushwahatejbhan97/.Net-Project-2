	...
	<div class="inner-banner-overlay">
		<div class="container">
							...
							<div class="w3layouts-banner-info-about">
								<h3 class="text-wh text-white">About Us</h3>
	...
	<div class="container py-lg-5 py-sm-3">
		<div class="row">
			<div class="col-lg-6 inner-about">
				...
				<h4 class="mt-md-4 mt-2">About Us</h4>
				<h5 class="bottom mt-sm-4 mt-3"></h5>
				<p class="">TOUR DESTINATIONS is managed by a group of experienced and committed professionals. All team members have passion towards the nature, travel and tourism. TOUR DESTINATIONS offer various services in travel and tourism related activities to the clients. For us we believe that every day is a new beginning with new challenges which is always adventurous. </p>
			<p>
			...
			<div class="col-lg-6 mt-lg-0 mt-4">
				<h5 class="bottom mt-sm-4 mt-3"></h5>
				<img src="/images/collage.png" class="img-fluid homeimg" alt="" />
			</div>
		</div>
	</div>
</section>
