	...
	<div class="inner-banner-overlay">
		<div class="container">
			...
			<div class="w3layouts-banner-info-about">
								<h3 class="text-wh text-white">Services</h3></div>
...
Various destinations across the globe have become places of attraction and interest for tourists. Tourists have their dream destinations to visit, enjoy and relax.</p>
			...
			<div class="col-lg-6 mt-lg-0 mt-4">
				<h5 class="bottom mt-sm-4 mt-3"></h5>
				<img src="images/wp3.jpg" class="img-fluid homeimg" alt="" />
			</div>
		</div>
	</div>
</section>
	...
	<!-- gallery -->
<div class="gallery py-sm-5 py-4 position-relative" style="background:#e9ecef"; id="gallery">
